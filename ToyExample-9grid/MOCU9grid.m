%run the surf figure with 9 pairs of different parameters
clear
% rng default
...
% tic
% EMocuRho(theta_dispara, rho_dispara, r, c, blurringT, sigma_)
% toc
rho_dispara = [0.5, 1.5, 5];% variance is 1/(1+2*rhodispara)
